...
export const FETCH_USERS_REQUEST = (state, action) => state;

export const FETCH_USERS_SUCCESS = (state, action) => (
  state.set('users', Immutable.fromJS(action.payload.users))
);

export const FETCH_USERS_FAILURE = (state, action) => state;

export const FETCH_USER_REQUEST = (state, action) => state;

export const FETCH_USER_SUCCESS = (state, action) => (
  state.set('currentUser', Immutable.fromJS(action.payload))
);

export const FETCH_USER_FAILURE = (state, action) => state;
